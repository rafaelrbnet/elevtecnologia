...
* Conhecimentos, Habilidades e Experiências que são Requeridas (Obrigatório): PHP,  Asterisk, Java Script / Jquery,  PostgreSql,  Linux
* Conhecimentos e Habilitadas que serão tratadas como Diferenciais: Git, Laravel, VueJS, Docker, CentOS 
